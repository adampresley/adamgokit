...
func (_mock *MockPublisher) Publish(event Event) {
	_mock.Called(event)
	return
}
...
func (_c *MockPublisher_Publish_Call) Run(run func(event Event)) *MockPublisher_Publish_Call {
...
func (_c *MockPublisher_Publish_Call) RunAndReturn(run func(event Event)) *MockPublisher_Publish_Call {
	_c.Run(run)
	return _c
}
